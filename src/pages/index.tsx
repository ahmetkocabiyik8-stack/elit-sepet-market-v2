      ...
      {media.type === "video" ? (
        <>
          <video
            ref={videoRef}
            src={media.src}
            className="h-[62%] w-full object-cover object-top bg-black"
            autoPlay
            muted={muted}
            loop
            playsInline
          ...
          <button
            ...
            className="absolute right-2.5 top-[calc(62%-38px)] z-10 grid h-8 w-8 place-items-center rounded-full bg-black/60 text-white shadow-md transition hover:bg-black/75"
          >

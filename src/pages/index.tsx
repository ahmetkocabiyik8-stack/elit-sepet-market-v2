      ...
      {slides.map((s, i) => (
        ...
        >
          <img
            ...
            alt=""
            aria-hidden="true"
            className="absolute inset-0 h-full w-full scale-110 object-cover object-center blur-2xl brightness-[0.6]"
          />
          <img
            src={s.image}
            alt={s.title}
            className="absolute inset-0 h-full w-full object-contain brightness-[0.92]"
          />
  ...
  return (
    ...
    >
      ...
      {media.type === "video" ? (
        ...
        >
          <img src={media.src} alt="Ürün" className="relative h-full w-full object-cover object-top" loading="lazy" />
        </div>
      )}
